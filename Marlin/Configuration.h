...
#define POLARGRAPH
  ...
  #define POLARGRAPH_MAX_BELT_LEN 1150.0
  #define POLAR_SEGMENTS_PER_SECOND 5

  //#define X_MIN_PIN       35  // AUX4_10_PIN
  //#define Y_MIN_PIN       34  // E1_DIR_PIN
  #define X_MAX_PIN       18  // AUX4_09_PIN
  #define Y_MAX_PIN       19  // E1_STEP_PIN
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 32, 32, 32 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 90*60 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 40*60, 40*60, 100 }
...
#define MANUAL_Y_HOME_POS -530.5 //(Y_MAX_POS-( sqrt(sq(POLARGRAPH_MAX_BELT_LEN)-sq(X_BED_SIZE/2))))
